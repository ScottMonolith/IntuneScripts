...
$adtSession = @{
    ...
    AppProcessesToClose = @('EmbravaConnect')
...
function Install-ADTDeployment
{
    ...
    $saiwParams = @{
        ...
        CheckDiskSpace = $true
        PersistPrompt = $true
		#WindowTitle = "$($adtSession.AppName) $($adtSession.AppVersion)"
		#WindowSubtitle = "Monolith Materials - App Install"
		#StatusMessage = "Installation in Progress..."
		#StatusMessageDetail = "The install process will take some time to complete, please be patient.  You can continue to use other apps while this application is being installed."
    }
	...
	if (Get-ADTApplication -Name 'Embrava Connect') {
		Uninstall-ADTApplication -Name 'Embrava Connect'
	}
	...
	Start-ADTMsiProcess -Action 'Install' -FilePath 'EmbravaConnect.msi' -ArgumentList '/qn Connections=TEAMS,SLACK ConnectionsSelected=TEAMS,SLACK SilentConnectionSettings=Yes StartApp=Yes AutoUpdateDisabled=No ManualUpdateDisabled=Yes'
...
function Uninstall-ADTDeployment
{
	...
	Start-ADTMsiProcess -Action 'Uninstall' -FilePath 'EmbravaConnect.msi' -ArgumentList '/qn PreserveSettings=No'
