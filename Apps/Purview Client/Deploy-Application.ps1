...
Try {
    ...
    [String]$appName = 'Purview Information Protection client'
    [String]$appVersion = '3.0.58.0'
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '12/05/2024'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-MSI -Action 'Install' -Path 'PurviewInfoProtection.msi'
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-MSI -Action Uninstall -Path 'PurviewInfoProtection.msi' -ContinueOnError $False
