...
$Type = "ToastReboot"
$CustomAppValue = "Update Notification"
...
$TitleText = "Your device has been updated and requires a restart."
$BodyText1 = "Please save your work and restart your device at your earliest convenience. Thank you in advance."
$Action1 = "ToastReboot:"
...
<toast scenario="$Scenario">
    ...
    <actions>
        <action activationType="protocol" arguments="$Action1" content="Restart Now" />
...
Write-Log -Message "Toast notification sent in regards to Windows Update."
